...
export default function MetasVendaTotal() {
    ...
    <div className="flex flex-col h-full p-6 gap-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-800">Total Vendas</h1>
            <p className="text-xs text-slate-400">Consolidado de metas de Vendas · Novos + Seminovos</p>
          </div>
        </div>
