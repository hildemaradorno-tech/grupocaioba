...
| 2 | Margem Bruta de Peças Balcão | ✅ Implementado |
...
Indicador 1 — Faturamento Total Peças Balcão: usa a mesma fonte do **Indicador 8 da Auditoria**
(RPR001, VEN − DVE líquido), somando **todas as lojas**, independente do filtro de
empresa selecionado na tela.

Indicador 2 — Margem Bruta de Peças Balcão: usa a mesma fonte do **Indicador 9 da Auditoria**
(margem de contribuição líquida ÷ faturamento líquido de Balcão × 100), também somando
**todas as lojas**.
